...
import { forgerJadiBot } from './plugins/jadibot-serbot.js';
...
if (connection == 'open') {
console.log(chalk.bold.green('\nAnya Forger Conectada con éxito'))
}
...
global.rutaJadiBot = join(__dirname, './forgerJadiBot')

if (global.forgerJadibts) {
...
forgerJadiBot({pathforgerJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
